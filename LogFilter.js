...
(function() {
	...
	if (!document.URL.match(
		new RegExp('(?:Special:(?:Contributions|Log|WhatLinksHere)|action=history)'))
	) return
	...
	if (document.URL.match('Special:Contributions')) logType = 'contribs'
	if (document.URL.match('action=history'))        logType = 'history'
	if (document.URL.match('Special:Log'))           logType = 'log'
	if (document.URL.match('Special:WhatLinksHere')) logType = 'links'
